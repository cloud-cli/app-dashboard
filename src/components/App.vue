<template>
  <!-- Sticky header -->
  <div class="sticky top-0 z-50 bg-white flex justify-between items-center px-4 py-2">
    ...
    <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-white">
      <nav class="mt-5 flex-1 space-y-1">
        <router-link v-for="route in navigation" :to="route.path"
          class="flex items-center text-gray-900 space-x-2 py-2 px-4" active-class="text-indigo-500 bg-gray-200">
